 ...
 * of <code>BitPatternChromosome</code>s and returns the resultant offspring.
 *
 * @author Nathan Parker
 * @version 1.0
 */

public class Steiner2DCrossover implements CrossoverStrategy
{
        ...
        int crosspoint)
    {
        ...
        if ((!(parent1 instanceof Steiner2DChromosome)) ||
            (!(parent2 instanceof Steiner2DChromosome)))
        ...
        children[0] = new Steiner2DChromosome();
        children[1] = new Steiner2DChromosome();
