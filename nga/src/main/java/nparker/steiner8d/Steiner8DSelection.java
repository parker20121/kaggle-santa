...
/**
 * Elitist selection algorithm for this Steiner point application. This
 * algorithm always selects the best member of the population. Also, it selects
 * 33 per cent of the population at random. The total is what is consider to be
...
public class Steiner8DSelection implements SelectionStrategy
{
