 ...
 * of <code>Steiner8DChromosome</code>s and returns the resultant offspring.
 *
 * @author Nathan Parker
 * @version 1.0
 */

public class Steiner8DCrossover implements CrossoverStrategy
{
    private static final float CROSSOVER_RATE = 0.6F;
        ...
        int crosspoint)
    {
        ...
        if (parent1 == null)
            ...
            throw new IllegalArgumentException("parent1 is undefined in " +
                "Steiner2DCrossover.crossChromosomes(Chromosome, Chromosome, " +
                "int)");
        ...
        if ((!(parent1 instanceof Steiner8DChromosome)) ||
            (!(parent2 instanceof Steiner8DChromosome)))
            ...
            throw new ClassCastException("parent1 and/or parent2 is not of " +
               "type Steiner2DChromosome in Steiner2DCrossover." +
        ...
        children[0] = new Steiner8DChromosome();
        children[1] = new Steiner8DChromosome();
    ...
    public Population crossChromosomes(Population p, Random rand)
    {
        ...
        if ((p == null) || (p.size() <= 0))
            throw new IllegalArgumentException("p is not defined in " +
                "Steiner2DCrossover.crossChromosomes(Population, RandomNumber" +
                "Generator)");
